          ...
          <div class="col-lg-12">
            ...
            <div class="tab-content">
              <div class="tab-pane fade show active" id="tab1">
                <div class="row">
                  <?php
                  $stmt = $DB_con->prepare('SELECT * FROM plans where city="lagoa" and type="2" and speed="300" ORDER BY id DESC');
                  $stmt->execute();
                  if ($stmt->rowCount() > 0) {
              ...
              <div class="tab-pane fade show" id="tab2">
                ...
                <div class="row">
                <?php
                  $stmt = $DB_con->prepare('SELECT * FROM plans where city="lagoa" and type="2" and speed="400" ORDER BY id DESC');
                  $stmt->execute();
                  if ($stmt->rowCount() > 0) {
                    while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                      extract($row);
