...
<head>
  ...
  <!-- Favicons -->
  <link href="./assets/img/igbi.jpg" rel="icon">
  <link href="./assets/img/igbi.jpg" rel="apple-touch-icon">

  <meta content="IGBI CashBack" name="description">
  <meta content="igbi, cashback, dinheiro, dinheiro de volta, cash" name="keywords">
  <meta name="description" content="IGBI CashBack" />
  ...
  <script>
    ...
    })(window, document, 'script', 'dataLayer', 'GTM-KDG6DJF');
  </script>
...
<body>
  ...
  <header id="header" class="fixed-top ">
    <div class="container d-flex align-items-center justify-content-between">
      <a href="index.php" class="logo"><img src="assets/img/igbi-branca.png" alt="" class="img-fluid"></a>

      <nav id="navbar" class="navbar">
        <ul>
          <li><a class="nav-link scrollto active" href="#hero">Home</a></li>
          <li><a class="nav-link scrollto" href="#about">Igbi Cashback</a></li>
          <li><a class="nav-link scrollto" href="#contact">Contato</a></li>
          <li><a class="getstarted scrollto" href="#about">Baixe agora</a></li>
        </ul>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-5 col-md-6 footer-links">
            <h4>IGBIPAY.COM.BR</h4>
            <ul>
              <li><i class="bx bx-chevron-right"></i> <a href="#">Home</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="#">Igbi Cashback</a></li>
  ...
  <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-KDG6DJF" height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
  ...
  <script src="assets/js/igbi.js"></script>
